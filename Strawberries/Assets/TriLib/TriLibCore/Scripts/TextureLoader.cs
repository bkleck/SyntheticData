...
namespace TriLibCore.Textures
{
    ...
    public static class TextureLoader
    {
        ...
        public static void LoadTexture(TextureLoadingContext textureLoadingContext)
        {
            ...
            if (!textureLoadingContext.TextureLoaded && textureLoadingContext.Texture.Data != null)
            {
            ...
            if (!textureLoadingContext.TextureLoaded && textureLoadingContext.Stream != null)
            {
#if TRILIB_USE_UNITY_TEXTURE_LOADER
                UnityLoadFromContext(textureLoadingContext);
#else
            ...
            if (!textureLoadingContext.TextureLoaded && textureLoadingContext.Texture.Filename != null)
            {
